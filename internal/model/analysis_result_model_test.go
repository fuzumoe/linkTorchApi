...
// TestAnalysisResultToDTO tests the conversion of AnalysisResult model to AnalysisResultDTO.
func TestAnalysisResultToDTO(t *testing.T) {
...
// TestAnalysisResultFromCreateInput tests the conversion from CreateAnalysisResultInput to AnalysisResult model.
func TestAnalysisResultFromCreateInput(t *testing.T) {
...
// TestAnalysisResultTableName checks the table name for AnalysisResult model.
func TestAnalysisResultTableName(t *testing.T) {
